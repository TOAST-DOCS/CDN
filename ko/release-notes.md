...
* Large File Optimization 기능 추가
	* 대용량 파일 서비스를 위한 기능을 설정할 수 있습니다. 자세한 내용은 [콘솔 가이드 > 캐시](./console-guide/#cache)를 참고하시기 바랍니다.

### 2022. 07. 26.

#### 기능 개선/변경
* 메서드 허용 설정 기능 추가
	* POST, DELETE, PUT, PATCH 요청을 허용하도록 설정할 수 있습니다. 자세한 내용은 [콘솔 가이드 > 메서드 허용 설정](./console-guide/#method)을 참고하시기 바랍니다.
* 캐시 설정 옵션 추가
	* 캐시 설정에 Bypass Cache, No Store 옵션이 추가되었습니다. 자세한 내용은 [콘솔 가이드 > 캐시](./console-guide/#cache)를 참고하시기 바랍니다.
...
* 원본 타입 설정 기능 추가
	* NHN Cloud의 오브젝트 스토리지와 인스턴스 정보를 조회하여 원본 서버로 설정할 수 있습니다. 자세한 내용은 [콘솔 가이드 > 원본 서버](./console-guide/#origin)를 참고하시기 바랍니다.

### 2021. 11. 23.

#### 기능 개선/변경
* 캐시 키 쿼리 문자열 포함 설정 기능이 추가되었습니다. 자세한 내용은 [콘솔 가이드 > 캐시](./console-guide/#cache)를 참고하시기 바랍니다.
...
#### 기능 개선/변경
* 루트 경로 접근 관리 기능이 추가되었습니다. 자세한 내용은 [콘솔 가이드 > 루트 경로 접근 관리](./console-guide/#root_path_access_control)를 참고하시기 바랍니다.
