...
* 도메인 별칭 기능 추가
	...
	* 자세한 내용은 [콘솔 가이드 > 도메인 별칭](./console-guide-gov/#alias_domain)을 참고하세요.
* 도메인 별칭 API 추가
	* 도메인 별칭 등록/조회/삭제, 도메인 검증, 검증 상태 새로고침, 검증 토큰 재발급 API가 추가되었습니다.
	* 자세한 내용은 [API v2.0 가이드 > 도메인 별칭 API](./api-guide-v2.0-gov/#alias_domain_api)를 참고하세요.
...
* 인증서 관리 기능 추가
	...
	* 상세한 내용은 [사용자 콘솔 가이드 > 인증서 관리](./console-guide-gov/#certificate)를 참고합니다.
