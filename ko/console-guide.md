...
> NHN Cloud Object Storage 컨테이너에 `ETag` 응답 헤더 형식 설정에 대한 자세한 내용은 Object Storage 서비스의 API 가이드 내 [컨테이너 설정 변경 > RFC를 준수하는 ETag 형식 사용 설정](/nhncloud/ko/Storage/Object%20Storage/ko/api-guide/#change-container-settings/)을 참고하세요.
