...
> CDN 서비스를 생성한 후 약 1시간 이내에는 Purge 요청에 실패할 수 있습니다. 이후에도 계속 실패하면 [NHN Cloud 고객 센터](https://www.gov-nhncloud.com/kr/support/inquiry)로 문의하세요.
...
> 4. 인증서 발급은 프로젝트당 5개로 제한됩니다. 한도 조정이 필요한 경우 [NHN Cloud 고객 센터](https://www.gov-nhncloud.com/kr/support/inquiry)로 문의하세요.
...
> -  도메인 검증 작업 완료 후 검증에 성공하면 몇 시간 내 인증서 발급 및 배포 작업이 진행됩니다. 하루 이상 진행되지 않으면 도메인 검증 작업 내용이 올바른지 확인합니다. 문제가 없는데도 진행되지 않으면 [NHN Cloud 고객 센터](https://www.gov-nhncloud.com/kr/support/inquiry)로 문의하세요.
...
> 설정을 올바르게 했는데도 24시간 이상 [CDN 서비스 연동 대기] 상태가 지속될 경우 [NHN Cloud 고객 센터](https://www.gov-nhncloud.com/kr/support/inquiry)로 문의하세요.
