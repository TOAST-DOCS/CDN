...
Appkey 및 SecretKey 확인 및 사용에 대한 자세한 내용은 [Appkey](docs.gov-nhncloud.com/ko/nhncloud/ko/public-api/appkey)를 참고하세요.

Appkey 대신 프로젝트 통합 Appkey를 사용할 수도 있습니다. 프로젝트 통합 Appkey는 NHN Cloud에서 하나의 프로젝트 내 여러 서비스에 대해 공통으로 사용할 수 있는 인증 키입니다.
프로젝트 통합 Appkey 생성 및 사용에 대한 자세한 내용은 [프로젝트 통합 Appkey](docs.gov-nhncloud.com/ko/nhncloud/ko/public-api/project-integrated-appkey)를 참고하세요.
