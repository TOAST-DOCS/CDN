...
#### 機能改善・変更 { #june-23-2026-feature-updates }
...
#### 機能追加 { #april-28-2026-added-features }
* ドメインエイリアス機能の追加
...
\t* 詳細については、[コンソールユーザーガイド > ドメインエイリアス](./console-guide/#alias_domain)をご参照ください。
* ドメインエイリアスAPIの追加
\t* ドメインエイリアスの登録/照会/削除、ドメイン検証の実行/状態更新、検証トークンの再発行を行うAPIを追加しました。
\t* 詳細については、[API v2.0 ガイド > ドメインエイリアスAPI](./api-guide-v2.0/#alias_domain_api)をご参照ください。
...
#### 機能改善/変更 { #april-29-2025-feature-updates }
* 統計Public APIサポート終了 
	* サポート終了API
		* トラフィック統計照会
		* HTTPステータスコード別統計照会
...
#### 機能改善/変更 { #march-12-2024-feature-updates }
* 画面UIデザインを変更
...
#### 機能改善/変更 { #june-27-2023-feature-updates }
* HTTPレスポンスヘッダ設定機能を追加
...
#### 機能改善/変更 { #august-23-2022-feature-updates }
...
#### 機能改善/変更 { #july-26-2022-feature-updates }
* メソッド許可設定機能を追加
...
#### 機能改善/変更 { #june-30-2022-feature-updates }
* 証明書API追加
...
#### 機能改善/変更 { #may-24-2022-feature-updates }
* Auth Token作成API追加
...
#### 機能改善/変更 { #december-28-2021-feature-updates }
...
#### 機能改善/変更 { #november-23-2021-feature-updates }
...
#### 機能改善/変更 { #july-27-2021-feature-updates }
...
#### 機能改善/変更 { #may-25-2021-feature-updates }
* ルートパスアクセス管理機能が追加されました。詳しい内容は[コンソールガイド > ルートパスアクセス管理](./console-guide/#root_path_access_control)をご覧ください。

<a id="october-6-2020"></a>
### 2020. 10. 06. { #october-6-2020 }

<a id="october-6-2020-feature-updates"></a>
#### 機能改善/変更 { #october-6-2020-feature-updates }
...
#### 機能改善/変更 { #june-23-2020-feature-updates }
...
#### 機能改善/変更 { #february-26-2019-feature-updates }
* 特定CDNサービスのパージエラーを修正 
...
#### 機能改善/変更 { #january-15-2019-feature-updates }
* CDNサービス部分修正APIを追加 
...
#### 機能改善/変更 { #august-28-2018-feature-updates }
...
#### 機能改善/変更 { #may-29-2018-feature-updates }
* CDN API 1.5 アップデート 
...
#### 機能改善/変更 { #january-25-2018-feature-updates }
* CDNサービス削除APIを追加 
...
#### 機能改善/変更 { #july-20-2017-feature-updates }
