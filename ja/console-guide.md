...
> NHN Cloud Object Storageコンテナでの`ETag`レスポンスヘッダ形式の設定に関する詳細は、Object StorageサービスのAPIガイド内の[コンテナ設定の変更 > RFCに準拠したETag形式の使用設定](/Storage/Object%20Storage/ja/api-guide/#change-container-settings)をご参照ください。
